...
SELECT order_no FROM orders ORDERED BY order_date;
...
SELECT * FROM orders WHERE purchase_amount between1000 and 2000;
...
SELECT MAX(purchase_amount) from oredrs;

SELECT MAX(purchase_amount) from oredrs;

SELECT COUNT(salesman_id) from oredrs;
