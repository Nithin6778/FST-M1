...
public class Activity5 {
	...
	@Test
	    public void smsTest() {
	        ...
	        driver.findElement(AppiumBy.id("recipient_text_view")).sendKeys("7731863081");
	        ...
	        driver.findElement(AppiumBy.id("compose_message_text")).sendKeys("Hello from Bujji");
	        
	        driver.findElement(AppiumBy.accessibilityId("Send SMS")).click();

	        
	        String messageTextSent = driver.findElement(AppiumBy.id("message_text")).getText();
	        Assert.assertEquals(messageTextSent, "Hello from Bujji");
	    }
